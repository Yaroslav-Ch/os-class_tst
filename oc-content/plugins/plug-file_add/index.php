...
*/
    ...
    function digitalgoods_install() {
        ...
        osc_set_preference('max_files', '5', 'digitalgoods', 'INTEGER');
        osc_set_preference('allowed_ext', 'jpg,png,jpeg,gif', 'digitalgoods', 'INTEGER');
    }
    ...
    osc_add_hook('comm_edit', 'digitalgoods_form');
    osc_add_hook('item_edit', 'digitalgoods_item_edit');

    osc_add_hook('add_comment', 'digitalgoods_upload_files');
